...
class AppDelegate: UIResponder, UIApplicationDelegate, NSURLConnectionDelegate, NSURLConnectionDataDelegate {
	...
	lazy var managedObjectModel: NSManagedObjectModel = {
	    ...
	    let modelURL = NSBundle.mainBundle().URLForResource("Minecraft_Customizer", withExtension: "momd")!
	...
	lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
	    ...
	    let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Minecraft_Customizer.sqlite")
